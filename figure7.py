...
peak = f[np.argmax(avg1)]
print('HEre is the peak:' + str(peak))
print(st1)
...
st = client.get_waveforms(network='II,IU,IC,CU', station='*', location='00', channel=chan_code, 
...
ax.plot(f,avg2, label='Hunga Tonga Mean', color='C8', linewidth=3)

ax.legend(loc ='upper left')
ax.text(3.68, 1.12+0.4, '$_0S_{28} - _0S_{29}$', color='C2', alpha=0.7, ha='center', fontsize=22)
ax.text(4.40, 1.12+0.4, '$_0S_{36} - _0S_{37}$', color='C3', alpha=0.7, ha='center', fontsize=22)
ax.text(3.63, 1.17+0.4, '$_0S_{28}$', color='C4', alpha=0.7, ha='center', fontsize=22)
ax.text(3.72, 1.20+0.4, '$_0S_{29}$', color='C5', alpha=0.7, ha='center', fontsize=22)

ax.text(4.53, 1.17+0.4, '$_0S_{38}$', color='C6', alpha=0.7, ha='center', fontsize=22)
ax.text(4.62, 1.195+0.4, '$_0S_{39}$', color='C7', alpha=0.7, ha='center', fontsize=22)


ax.text(3.81, 1.225+0.4, '$_0S_{30}$', color='C9', alpha=0.7, ha='center', fontsize=22)
ax.plot([3.81, 3.81], [-1,2],color='C9',alpha=0.7)

ax.text(4.435, 1.188+0.4, '$_0S_{37}$', color='C10', alpha=0.7, ha='center', fontsize=22)
ax.plot([4.435, 4.435], [-1,2],color='C10',alpha=0.7)
